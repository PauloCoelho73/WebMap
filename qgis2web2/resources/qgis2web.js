...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-831786.718744, 4943859.832021, -828913.442572, 4945591.933677], maxZoom: 28, minZoom: 15
    })
});


map.getView().fit([-831786.718744, 4943859.832021, -828913.442572, 4945591.933677], map.getSize());
